---
title: "Manipulating, analyzing and exporting data with tidyverse - Answers"
...
that contains the survey data from Figshare. Inside the download.file command, the first entry is a character string with the source URL 
